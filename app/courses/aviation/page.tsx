...
export default function AviationCoursesPage() {
  ...
  return (
    <PageTemplate title="دورات الطيران" subtitle="برنامج الدورة" description="برنامج دورات الطيران">
      <div className="max-w-4xl mx-auto space-y-8" dir="rtl">
        {/* Course Management Interface */}
        <section className="bg-white rounded-2xl p-8 shadow-lg">
          <h2 className="text-2xl font-bold text-gray-800 mb-4 text-right">برنامج الدورة</h2>
          <p className="text-gray-700 text-right mb-6">برنامج يشمل الطيران المدني، الملاحة الجوية، صيانة الطائرات، وإدارة الطيران.</p>

          <CourseAdmin tableName="aviation_courses" title="دورات الطيران" />
        </section>
