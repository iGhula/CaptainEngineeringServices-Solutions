...
export default function EngineeringCoursesPage() {
  ...
  return (
    <PageTemplate title="الدورات الهندسية" subtitle="برنامج الدورة" description="برنامج الدورات الهندسية المتاحة">
      <div className="max-w-4xl mx-auto space-y-8" dir="rtl">
        ...
        <section className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-gray-700 text-right mb-6">
            فيما يلي برنامج الدورات الهندسية المتاحة لدينا مع المواعيد والمدة والتكلفة.
          </p>

          <CourseAdmin tableName="engineering_courses" title="الدورات الهندسية" />
        </section>
